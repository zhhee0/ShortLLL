...
public class UserServiceImpl extends ServiceImpl<UserMapper, UserDO> implements UserService {
    ...
    public void update(UserUpdateReqDTO requestParam) {
        ...
        if (Objects.equals(requestParam.getUsername(), "heng123")) {
            if (StrUtil.isNotBlank(requestParam.getPassword())) {
                throw new ClientException("公用账号不能修改密码");
            }
            ...
            if (!Objects.equals(requestParam.getMail(), userDO.getMail())
                    || !Objects.equals(requestParam.getPhone(), userDO.getPhone())
                    || !Objects.equals(requestParam.getRealName(), userDO.getRealName())) {
                throw new ClientException("公用账号不能修改个人信息");
            }
        }
