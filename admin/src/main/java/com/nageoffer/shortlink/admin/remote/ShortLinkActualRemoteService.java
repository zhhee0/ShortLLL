...
public interface ShortLinkActualRemoteService {
    ...
    void saveRecycleBinBatch(@RequestBody List<RecycleBinSaveReqDTO> requestParam);
     ...
     * 批量恢复短链接
     *
     * @param requestParam 批量恢复短链接请求参数
     */
    @PostMapping("/api/short-link/v1/recycle-bin/recover/batch")
    void recoverRecycleBinBatch(@RequestBody List<RecycleBinRecoverReqDTO> requestParam);
    ...
    void removeRecycleBinBatch(@RequestBody List<RecycleBinRemoveReqDTO> requestParam);
