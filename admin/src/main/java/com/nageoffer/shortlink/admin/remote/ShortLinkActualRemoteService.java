...
public interface ShortLinkActualRemoteService {
        ...
        void saveRecycleBinBatch(@RequestBody List<RecycleBinSaveReqDTO> requestParams);
        ...
        void recoverRecycleBinBatch(@RequestBody List<RecycleBinRecoverReqDTO> requestParams);
        ...
        void removeRecycleBinBatch(@RequestBody List<RecycleBinRemoveReqDTO> requestParams);
