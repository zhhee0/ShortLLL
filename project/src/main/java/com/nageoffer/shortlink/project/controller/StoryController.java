...
public class StoryController {
    ...
    public Result<Void> deleteStory(@RequestBody StoryDeleteReqDTO requestParam) {
        storyService.deleteStory(requestParam);
        return Results.success();
    }
    ...
    public Result<StoryLikeRespDTO> likeStory(@RequestBody StoryLikeReqDTO requestParam) {
        return Results.success(storyService.likeStory(requestParam));
    }
}
