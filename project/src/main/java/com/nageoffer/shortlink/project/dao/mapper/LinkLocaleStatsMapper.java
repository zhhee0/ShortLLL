...
public interface LinkLocaleStatsMapper extends BaseMapper<LinkLocaleStatsDO> {
    ...
    @Select("SELECT " +
            ...
            "    AND tlls.date BETWEEN #{param.startDate} and #{param.endDate} " +
            "GROUP BY " +
            "    tlls.full_short_url, tl.gid, tlls.province, tlls.city, tlls.adcode;")
    List<LinkLocaleStatsDO> listCityLocaleByShortLink(@Param("param") ShortLinkStatsReqDTO requestParam);
    ...
    @Select("SELECT " +
            ...
            "    AND tlls.date BETWEEN #{param.startDate} and #{param.endDate} " +
            "GROUP BY " +
            "    tl.gid, tlls.province, tlls.city, tlls.adcode;")
    List<LinkLocaleStatsDO> listCityLocaleByGroup(@Param("param") ShortLinkGroupStatsReqDTO requestParam);
}
