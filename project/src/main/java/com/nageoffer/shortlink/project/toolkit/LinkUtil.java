...
public class LinkUtil {
    ...
    public static String getActualIp(HttpServletRequest request) {
        String ipAddress = extractForwardedFor(request.getHeader("X-Forwarded-For"));
    ...
    private static String extractForwardedFor(String forwardedFor) {
    ...
    private static String normalizeIp(String ip) {
        ...
        // Handle IPv4 with port like "1.2.3.4:5678"
    ...
    private static boolean isPublicIpv4(String ip) {
        ...
        if (StrUtil.isBlank(normalized) || normalized.indexOf('.') < 0) {
            return true;
        }
